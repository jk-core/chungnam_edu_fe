  ...
  */
  ...
  { path: `${PATH.KIOSK}/:orgId`, element: <KioskRedirect /> },
  {
    ...
    children: [
      ...
      { path: PATH.CONTROL_1, element: <ControlRoomDraftPage draft="1" /> },
      { path: PATH.CONTROL_2, element: <ControlRoomDraftPage draft="2" /> },
      { path: PATH.CONTROL_3, element: <ControlRoomDraftPage draft="3" /> },
      { path: PATH.CONTROL_4, element: <ControlRoomDraftPage draft="4" /> },
      { path: PATH.CONTROL_5, element: <ControlRoomDraftPage draft="5" /> },
      {
        path: PATH.HOME,
        element: <RootLayout />,
        children: [
