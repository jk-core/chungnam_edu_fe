 ...
 */
export function JourneyOverviewArt({ stats }: JourneyOverviewArtProps) {
  return (
    <svg
      viewBox="0 0 380 230"
      width="100%"
    ...
    >
      ...
      */}
      ...
      <g fontFamily="Pretendard Variable, sans-serif">
        <StageTag x={44} y={78} step="1" label="햇빛" />
        <StageTag x={66} y={219} step="2" label="태양전지" />
        <StageTag x={214} y={62} step="3" label="인버터" />
        <StageTag x={306} y={216} step="4" label="학교·전기망" />
      </g>
    </svg>
  );
}
