  ...
  principle: {
    ...
    stages: [
      ...
      },
      {
        ...
        term: '태양전지가 전기를 만든다',
        body:
          '지붕에 깔린 판을 태양전지라고 한다. 태양전지는 햇빛을 받으면 전기가 흐르도록 만든 부품이다. '
          + '햇빛이 닿는 동안 계속 전기가 만들어진다.',
      },
      {
        id: 'inverter',
        step: 3,
        term: '인버터가 교류로 바꾼다',
        body:
          '태양전지가 만든 전기는 한 방향으로만 흐르는 직류다. 교실 콘센트에 오는 전기는 방향이 계속 '
          + '바뀌는 교류다. 인버터가 직류를 교류로 바꿔 주어야 교실에서 그대로 쓸 수 있다.',
      },
      {
        id: 'school',
        step: 4,
