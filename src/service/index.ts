...
/*
  ...
  경로의 판 번호(v1.0)는 여기 한 곳에만 적는다: 도메인마다 적으면 판이 오를 때 스물몇 곳을 고쳐야 한다.
*/
const BASE_URL = `${import.meta.env.VITE_APP_API_PATH ?? ''}/api/v1.0`;
...
/** 서버가 파일을 만들어 내려주는 호출의 제한시간 — 엑셀은 5초를 상시 넘긴다 */
