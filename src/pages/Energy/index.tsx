...
import { FieldTab } from '@/pages/Reports/components/FieldTab';
import { HistoryTab } from '@/pages/Collection/components/HistoryTab';
import { OverviewTab } from '@/pages/Statistics/components/OverviewTab';

/**
 * 발전관리 — 발전통계·운전이력·현장보고서.
 * 흩어져 있던 통계·수집·보고 화면을 한 대분류로 모았다.
 */
const TABS = {
  statistics: OverviewTab,
  history: HistoryTab,
  'field-report': FieldTab,
} as const;
